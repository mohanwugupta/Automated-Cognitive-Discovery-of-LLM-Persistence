...
| Opening OpenAI/Hugging Face incident narrative | Update 9 September 2026: an [official OpenAI disclosure](https://openai.com/index/hugging-face-model-evaluation-security-incident/) verifies the incident. The previous verification requirement is no longer a reason to treat it as unsupported. The scientific introduction still stands on cognitive literature; the incident does not identify a persistence mechanism. Verify the separate Hugging Face disclosure and Black Hat talk before quoting either. |
