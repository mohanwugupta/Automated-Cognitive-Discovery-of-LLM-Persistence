...
def summarize_transfer(frame, *, model, theory, source_task, target_task, layer, rank, bootstrap_samples=2000, seed=27001, random_cfrs=None):
    ...
    return {
        ...
        "target_task": target_task, "layer": int(layer), "rank": int(rank),
        "n_train": int(frame.attrs.get("n_train", 0)), "n_test": int(len(frame)),
